...
async def test_hooks_command_block():
    ...
    from illusion_forge.hooks.schemas import CommandHookDefinition
...
async def test_skills_load():
    ...
    from illusion_forge.skills.loader import load_user_skills
...
""")
        ...
        import illusion_forge.skills.loader as sl
...
async def test_plugins_load():
    ...
    from illusion_forge.plugins.loader import load_plugin
...
async def test_memory_lifecycle():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        import illusion_forge.memory.paths as mp
        ...
        import illusion_forge.memory.manager as mm
...
async def test_config_settings():
    ...
    from illusion_forge.config.settings import Settings, load_settings
...
async def test_mcp_types():
    ...
    from illusion_forge.mcp.types import McpConnectionStatus, McpStdioServerConfig, McpToolInfo
...
async def test_combined_hooks_skills_agent():
    ...
    from illusion_forge.engine.messages import ConversationMessage
    from illusion_forge.engine.query import QueryContext, run_query
    from illusion_forge.engine.stream_events import AssistantTextDelta, ToolExecutionStarted
    from illusion_forge.hooks.events import HookEvent
    from illusion_forge.hooks.executor import HookExecutionContext, HookExecutor
    from illusion_forge.hooks.loader import HookRegistry
    from illusion_forge.hooks.schemas import CommandHookDefinition
...
async def test_full_swarm_autoagent():
    ...
    import illusion_forge.swarm.mailbox as mb
    import illusion_forge.swarm.team_lifecycle as tl
    from illusion_forge.swarm.team_lifecycle import TeamLifecycleManager, TeamMember
    ...
    from illusion_forge.permissions.checker import PermissionChecker
    from illusion_forge.permissions.modes import PermissionMode
    from illusion_forge.swarm.in_process import TeammateAbortController, start_in_process_teammate
    from illusion_forge.swarm.types import TeammateSpawnConfig
    from illusion_forge.tools.base import ToolRegistry
    from illusion_forge.tools.bash_tool import BashTool
    from illusion_forge.tools.file_read_tool import FileReadTool
    from illusion_forge.tools.glob_tool import GlobTool

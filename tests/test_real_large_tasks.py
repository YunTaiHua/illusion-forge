...
async def task_migration_plan_with_memory():
    ...
    from illusion_forge.services.session_storage import export_session_markdown, get_project_session_dir, write_index, write_meta
...
async def task_full_pipeline():
    ...
    import illusion_forge.swarm.mailbox as mb
    import illusion_forge.swarm.team_lifecycle as tl
    from illusion_forge.swarm.permission_sync import (

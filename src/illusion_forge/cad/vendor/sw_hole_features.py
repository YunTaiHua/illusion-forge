...
def _feature_name(feature: Any, fallback: str) -> str:
...
def _circle_cut(model: Any, plane_name: str, center: tuple[float, float], diameter: float, depth: float, feature_name: str) -> Any:
...
def _find_hole_entry_edge(model: Any, plane_name: str, center: tuple[float, float], radius: float, tolerance: float=1e-6) -> Any:
...
def _chamfer_hole_entry(model: Any, plane_name: Any, center: Any, hole_diameter: Any, countersink_diameter: Any, half_angle_rad: Any, feature_name: Any) -> Any:
...
def create_blind_hole(model: Any, center: Any, diameter: float, depth: float, plane_name: Any="Front Plane", name: str="盲孔") -> dict[str, Any]:
...
def create_through_hole(model: Any, center: Any, diameter: float, plane_name: Any="Front Plane", name: str="通孔") -> dict[str, Any]:
...
def create_counterbore_hole(model: Any, center: Any, hole_diameter: Any, counterbore_diameter: Any, counterbore_depth: Any, plane_name: Any="Front Plane", name: str="沉孔", ) -> dict[str, Any]:
...
def create_countersink_hole(model: Any, center: Any, hole_diameter: Any, countersink_diameter: Any, included_angle_deg: Any=90.0, plane_name: Any="Front Plane", name: str="沉头孔", ) -> dict[str, Any]:
...
def create_semicircular_slot(model: Any, start: Any, end: Any, width: float, depth: float=0.0, plane_name: Any="Front Plane", name: str="半圆端槽", ) -> dict[str, Any]:
...
def create_hole_pattern(model: Any, positions: Iterable[Sequence[float]], creator: Any, **kwargs: Any) -> list[dict[str, Any]]:

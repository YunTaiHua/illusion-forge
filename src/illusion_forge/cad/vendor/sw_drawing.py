...
# pyright: reportUnsupportedDunderAll=false —— 本文件即动态 __all__ 桥接
...
唯一改动：_IMPLEMENTATION 指向本包内的 drawing_workflow.py 副本。
"""
...
_IMPLEMENTATION = Path(__file__).resolve().parent / "drawing_workflow.py"

...
def _motion_typelib_candidates() -> Any:
...
def ensure_motion_type_library(raise_on_error: bool=False) -> Any:
    """
...
def motion_member(obj: Any, attr_name: str, *args: Any) -> Any:
    """
...
def get_motion_study_manager(asm_model: Any, load_type_library: bool = True) -> Any:
    """
...
def create_motion_study(asm_model: Any, name: str | None = None, duration: float = 4.0,
                        study_type: Any = None) -> Any:
    """
...
def _set_first_supported(obj: Any, names: Any, value: Any) -> Any:
    """按候选属性名设置第一个可用属性。"""
    last_error = None
    for name in names:
        try:
...
def _set_load_references(motor_data: Any, references: Any) -> Any:
    """
...
def add_constant_speed_rotary_motor(
    motion_study: Any,
    direction_reference: Any,
    load_reference: Any,
    rpm: float = 60.0,
    relative_component: Any = None,
    name: str | None = None,
    reverse: bool = False,
) -> Any:
    """
...
def add_constant_speed_rotary_motor_by_cylinders(
    ...
    shaft_component: Any,
    rotor_component: Any,
    shaft_radius: Any = None,
    rotor_radius: Any = None,
    rpm: float = 60.0,
    name: str | None = None,
    reverse: bool = False,
) -> Any:
...
def calculate_and_play(motion_study: Any, play: Any=True) -> Any:
    """
...
def _collect_motion_features(motion_study: Any) -> Any:
...
def collect_motion_study_summary(asm_model: Any) -> Any:
    """
...
def validate_motion_study_summary(
    ...
    expected_study_type: Any = None,
    minimum_duration_seconds: float = 0.001,
    minimum_motor_count: int = 1,
    ...
    def check(check_id: Any, passed: Any, failure_message: Any, study: Any=None, success_message: Any=None) -> Any:
        """@brief 追加单条验收检查。"""
...
def validate_motion_studies(asm_model: Any, **requirements: Any) -> Any:

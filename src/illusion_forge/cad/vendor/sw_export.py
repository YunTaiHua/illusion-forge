...
def export_to_step(model: Any, output_path: Any) -> Any:
    """导出为 STEP 格式"""
    return _export_generic(model, output_path)


def export_to_stl(model: Any, output_path: Any, quality: Any="fine") -> Any:
    """
    导出为 STL 格式
...
def export_to_iges(model: Any, output_path: Any) -> Any:
    """导出为 IGES 格式"""
    return _export_generic(model, output_path)


def export_to_parasolid(model: Any, output_path: Any) -> Any:
    """导出为 Parasolid (.x_t) 格式"""
    return _export_generic(model, output_path)


def export_to_pdf(model: Any, output_path: Any, sheet_names: Any=None) -> Any:
    """
    导出工程图为 PDF
...
def _sheet_metal_alignment_variant(alignment: Any=None) -> Any:
...
def export_to_dxf(model: Any, output_path: Any) -> Any:
    """
    导出为 DXF/DWG 格式
    适用于工程图或钣金展开图
    """
...
def batch_export(sw: Any, file_paths: Any, output_dir: Any, format_ext: Any=".step") -> Any:
    """
    批量导出多个文件
...
def _normalize_format(format_ext: Any) -> Any:
    """规范化并校验批量导出扩展名。"""
...
def _file_signature(path: Any) -> Any:
...
def _activate_source_document(sw: Any, model: Any, source_path: Any) -> Any:
    ...
    except (com_error, AttributeError, ValueError, OSError, KeyError, IndexError):
        try:
...
def _export_for_format(model: Any, output_path: Any, extension: Any, stl_quality: Any) -> Any:
    """按已验证封装路由导出格式。"""
...
def batch_export_formats(
    ...
    *,
    ...
    for source_path in source_paths:
        ...
        document_result: dict[str, Any] = {"source": source_path, "success": False, "outputs": [], "was_open": False}
        ...
        try:
            for extension in extensions:
                ...
                except (com_error, AttributeError, TypeError, ValueError, OSError, KeyError, IndexError) as error:
...
def _export_generic(model: Any, output_path: Any) -> Any:
...
def _print_result(format_name: Any, path: Any, success: Any, errors: Any, warnings: Any) -> Any:
    """打印导出结果"""
    if success:

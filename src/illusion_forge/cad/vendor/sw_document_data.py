...
def inspect_configurations(model: Any) -> dict[str, Any]:
...
def activate_configuration(model: Any, configuration_name: str, *, rebuild: bool = True, save: bool = False, ) -> dict[str, Any]:
...
def create_configuration(model: Any, configuration_name: str, *, comment: str = "", alternate_name: str = "", options: int = 0, if_exists: str = "reuse", activate: bool = True, rebuild: bool = True, save: bool = False, ) -> dict[str, Any]:
...
def _dimension_value_mm(dimension: Any, configuration_name: str | None = None) -> float:
    """读取尺寸系统值并转为毫米。"""
...
def update_dimension_mm(model: Any, dimension_name: str, value_mm: float, *, configuration_mode: str = "current", configuration_names: Sequence[str] | None = None, rebuild: bool = True, save: bool = False, ) -> dict[str, Any]:
    """修改命名尺寸并返回可审计证据。
...
def _property_manager(model: Any, configuration_name: str = "") -> Any:
...
def read_custom_property(model: Any, name: str, *, configuration_name: str = "") -> dict[str, Any]:
    """读取一个文件级或配置级自定义属性。"""
...
def set_custom_properties(model: Any, properties: Mapping[str, Any], *, configuration_name: str = "", property_type: str = "text", save: bool = False, ) -> dict[str, Any]:
    """写入文件级或配置级属性，并逐项回读验证。"""
    if not properties:

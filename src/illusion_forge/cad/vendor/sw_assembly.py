...
def _as_alias_list(aliases: Any) -> Any:
    """将字符串或序列统一成非空名称列表。"""
...
def _active_solidworks_app() -> Any:
...
def _activate_model_document(sw: Any, model: Any) -> Any:
...
def _add_component5(asm_model: Any, component_path: Any, config_name: Any, x: float, y: float, z: float) -> Any:
...
def _add_component4(asm_model: Any, component_path: Any, config_name: Any, x: float, y: float, z: float) -> Any:
    """调用 AddComponent4。"""
...
def add_component(asm_model: Any, part_path: Any, x: float=0, y: float=0, z: float=0, config_name: Any="", sw: Any=None) -> Any:
    """
    向装配体添加零部件
...
def resolve_component(component: Any, state: Any=SW_COMPONENT_FULLY_RESOLVED) -> Any:
    """
...
def get_component_model(component: Any, resolve: Any=True, raise_on_error: bool=True) -> Any:
    """
...
def get_component_feature(component: Any, aliases: Any, resolve: Any=True) -> Any:
    """
...
def get_assembly_entity(component: Any, feature_or_face: Any) -> Any:
    """
...
def get_component_feature_entity(component: Any, aliases: Any, resolve: Any=True) -> Any:
    """
...
def find_largest_cylinder_face(component: Any, min_radius: Any=0.0, max_radius: Any=None, resolve: Any=True) -> Any:
    """
...
def select_entities_for_mate(model: Any, entity1: Any, entity2: Any, mark: int=1) -> Any:
    """
...
def add_mate5_checked(
    ...
    flip: bool = False,
    distance: float = 0.0,
    distance_upper: Any = None,
    distance_lower: Any = None,
    gear_num: float = 0.0,
    gear_den: float = 0.0,
    angle: float = 0.0,
    angle_upper: Any = None,
    angle_lower: Any = None,
...
def build_transform_data_x(tx: Any, ty: Any, tz: Any, angle_rad: Any=0.0) -> Any:
    """
...
def apply_component_transform_x(component: Any, tx: Any, ty: Any, tz: Any, angle_rad: Any=0.0) -> Any:
    """
...
def iter_feature_tree(model: Any, include_subfeatures: Any=True) -> Any:
    """
    ...
    """
    def walk_subfeatures(parent: Any, depth: float) -> Any:
...
def collect_mate_feature_summary(model: Any) -> Any:
    """
...
def add_mate_coincident(asm_model: Any, entity1_name: Any, entity1_type: Any, entity2_name: Any, entity2_type: Any) -> Any:
    """
    添加重合配合
...
def add_mate_concentric(asm_model: Any, face1_name: Any, face2_name: Any) -> Any:
    """添加同心配合"""
    asm_model.ClearSelection2(True)
...
def add_mate_distance(asm_model: Any, entity1_name: Any, entity1_type: Any, entity2_name: Any, entity2_type: Any, distance: float) -> Any:
    """
    添加距离配合
...
def add_mate_parallel(asm_model: Any, face1_name: Any, face2_name: Any) -> Any:
    """添加平行配合"""
    asm_model.ClearSelection2(True)
    _select_by_id(asm_model.Extension, face1_name, "FACE", mark=1)
    _select_by_id(asm_model.Extension, face2_name, "FACE", append=True, mark=1)
...
def get_components(asm_model: Any, top_level_only: bool=True) -> Any:
    """
    获取装配体中的所有组件
...
def find_component_by_name(asm_model: Any, keyword: Any, top_level_only: bool=True, case_sensitive: bool=False) -> Any:
    """
...
def suppress_component(asm_model: Any, component_name: Any) -> Any:
    """压缩（隐藏）组件"""
    _select_by_id(asm_model.Extension, component_name, "COMPONENT")
    asm_model.EditSuppress()


def unsuppress_component(asm_model: Any, component_name: Any) -> Any:
    """解压缩（显示）组件"""
    _select_by_id(asm_model.Extension, component_name, "COMPONENT")
    asm_model.EditUnsuppress()


def replace_component(asm_model: Any, old_component_name: Any, new_part_path: Any) -> Any:
    """
    替换装配体中的组件
...
def get_interference_detection(asm_model: Any) -> Any:
    """运行干涉检查并返回可审计报告。"""
    try:
